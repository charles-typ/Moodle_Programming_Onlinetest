...
<body>
PLEASE INPUT THE ID OF THE COURSE YOU WANT TO GET GRADES.<br />
...
if (has_capability('moodle/course:create', $systemcontext)){
	...
	if($_GET["test_id"])
	{
		...
		if (!ereg("^[0-9]+$",$test_id)){
			...
			header("Location: http://192.168.47.168/moodle/course/calresultconfig.php");
		}
		else
		{
			...
			if($www)
			{
				echo	"ARE YOU SURE TO GET THE GRADES OF COURSE ".$www."?"."<br />";
				if(!empty($_POST['submit1'])){
				$wwwroot = $CFG->wwwroot;
				$wwwroot .="/course/calresult.php?course_cat=$course_cat"; 
